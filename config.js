                ...
                widgets: [
                  {
                    ...
                    title: '苏为华',
                    fa: 'fa fa-group',
                    content: '<div style="width:95%;margin:0 auto"><p style="text-indent:36px;">经济学博士，教授，博士生导师，浙江工商大学副校长。享受国务院政府特殊津贴，原国内贸易部突出贡献专家，浙江省高校中青年学科带头人，浙江省151人才工程第一层次人选。目前主要从事政府统计体制改革、指数理论与应用、评估理论与方法、数据挖掘与决策等方面的研究工作。</p></div>',
                  ...
                  },
                  {
                    ...
                    title: '陈骥',
                    fa: 'fa fa-group',
                    content: '<div style="width:95%;margin:0 auto"><p style="text-indent:36px;">经济学博士，教授，硕士生导师。教育部人文社会科学重点研究基地——浙江工商大学现代商贸研究中心、浙江省2011协同创新中心——“现代商贸流通体系建设协同创新中心”、浙江财经大学经济与社会发展研究院兼职研究人员。主要从事政府统计制度、商贸流通统计、电子商务统计监测、大数据管理决策等方面的研究。多项成果获教育部及各级统计部门奖励。</p></div>',
                  ...
                  },
                  {
                    ...
                    title: '张涛',
                    fa: 'fa fa-group',
                    content: '<div style="width:95%;margin:0 auto"><p style="text-indent:36px;">软件工程硕士，工程师。曾先后供职于浙大网新科技股份有限公司、杭州信雅达系统工程股份有限公司、UT斯达康（中国）有限公司、中国电力科学研究院软件工程实验室。先后获得过Microsoft Architects 2000、BEA WLS-D、IBM WSBCC、Raytron SDP&M、Cisco CCNP、Cisco ICSG等认证。2003年入选杭州市“131”中青年人才培养计划。</p></div>',
